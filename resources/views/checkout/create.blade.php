...
<main class="max-w-3xl mx-auto px-6 py-20">
    <div class="mb-12">
        <a href="{{ route('detail-event') }}" class="text-indigo-600 font-bold flex items-center gap-2 mb-6">
    ...
    <div class="grid grid-cols-1 gap-8">
        <div class="bg-white rounded-3xl border border-slate-200 p-8 shadow-sm">
            ...
            <div class="flex gap-6 items-start">
                ...
                <div>
                    ...
                    <p class="text-slate-500">{{ \Illuminate\Support\Carbon::parse($event->date)->format('d M Y') }} • {{ $event->location }}</p>
        ...
        <div class="bg-white rounded-3xl border border-slate-200 p-8 shadow-sm">
            <div class="mb-6 border-b pb-4">
                <h3 class="text-xl font-bold text-slate-800">Data Pemesan</h3>
                <p class="text-slate-400 text-sm">Pastikan informasi di bawah ini sudah benar</p>
            </div>

            @guest
                <div class="mb-6 p-4 bg-indigo-50 border border-indigo-100 rounded-2xl flex items-center justify-between flex-wrap gap-4">
                    <div class="flex items-center gap-3">
                        <div class="w-10 h-10 bg-indigo-600 text-white rounded-xl flex items-center justify-center font-bold text-sm">AH</div>
                        <div>
                            <p class="font-bold text-slate-800 text-sm">Pesan Tiket Lebih Cepat</p>
                            <p class="text-xs text-slate-500">Lewati pengisian manual dengan sekali klik.</p>
                        </div>
                    </div>
                    <a href="{{ route('auth.google') }}" class="px-4 py-2 bg-indigo-600 hover:bg-indigo-700 text-white text-xs font-bold rounded-xl transition shadow-md shadow-indigo-200 flex items-center gap-2">
